...
export function UpdateReimbursementForm(props: ReimProps){
    ...
    <div className="form-input-cont">
        ...
        <input className="form-inputs" type="datetime-local" value={props.form.date_of_expense} onChange={e => props.setForm({...props.form, date_of_expense: new Date(e.target.value).getTime()/1000})}></input>
